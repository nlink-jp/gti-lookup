...
// changes the answer. Parts that are safe as a filename are kept readable so a
// human can inspect the cache directory; anything longer or containing awkward
// characters is hashed, which also keeps filenames inside filesystem limits
// for long URLs and hostnames.
