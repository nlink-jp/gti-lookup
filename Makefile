...
## e2e: Live end-to-end tests against the real GTI API (network + licence key required)
e2e: build
...
BREW_KIND := formula
BREW_DESC := Curated threat-actor context for an indicator, from Google Threat Intelligence
